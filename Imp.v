...
Theorem beval_iff_bevalR : forall e b,
  ...
  split.
  Case "->".
    intros H; induction H; subst; simpl; try (reflexivity);
    try (rewrite aeval_iff_aevalR' in H; rewrite aeval_iff_aevalR' in H0;
         rewrite H; rewrite H0; reflexivity).
  Case "<-".
    generalize dependent b.
    induction e; simpl; intros; subst; try(constructor);
...
(* <$Date: 2013-02-20 17:21:18 -0500 (Wed, 20 Feb 2013) $ *)
