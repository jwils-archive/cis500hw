...
Fixpoint convert_bin_nat( b : bin) : nat :=
  match b with
    | Z => O
...
Example test_bin_2: ( convert_bin_nat ( increment( increment ( increment Z) ) ) ) = 3.
reflexivity. Qed.


Example test_bin_3: ( convert_bin_nat ( T(K(T(T(K(Z)))))) ) + 1 =  (convert_bin_nat (increment (T(K(T(T(K(Z)))))))).
reflexivity. Qed.
