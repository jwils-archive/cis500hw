(* Ayaka Nonaka & Josh Wilson *) (* 6 hours *)
...
Proof.
  intros b b' c1 c1' c2 c2' H1 H2 H3 ; split ; intros H.
  Case "->".
    inversion H. subst.
    unfold bequiv in H1.
    unfold cequiv in H2.
...
Proof. 
  ...
  Case "WHILE".
    assert (bequiv b (fold_constants_bexp b)).
        SSCase "Pf of assertion". apply fold_constants_bexp_sound.
      remember (fold_constants_bexp b) as b'.
    bexp_cases (destruct b') SCase;
