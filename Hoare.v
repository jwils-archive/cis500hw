...
Proof.
  eapply hoare_seq.
  eapply hoare_asgn.
  unfold assn_sub. unfold update. simpl.
...
since the value of 'a' could since we update X to be 3 (unless X was already 3 to begin with). *)
...
(* $Date: 2013-03-14 17:45:28 -0400 (Thu, 14 Mar 2013) $ *)
